...
export const translations = {
  en: {
    ...
    reset_instructions: "Enter your email and we'll send you a 6-digit code.",
    reset_send_code: 'Send code',
    reset_code_sent: 'Check your email for a 6-digit code. It may take a minute.',
  ...
  es: {
    ...
    reset_instructions: 'Escribe tu correo y te enviaremos un código de 6 dígitos.',
    reset_send_code: 'Enviar código',
    reset_code_sent: 'Revisa tu correo — te enviamos un código de 6 dígitos. Puede tardar un minuto.',
    reset_code_label: 'Código de 6 dígitos',
